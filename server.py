...
def success():
    ...
    output_begin_string1 = "Earliest harvest date:  " + returned_begin_date
    ...
    days_to_returned_end_date =(returned_end_date_obj - today).days+dateadjustment #captures edge case crops
    output_begin_string2 = "Latest harvest date:  " + returned_end_date
